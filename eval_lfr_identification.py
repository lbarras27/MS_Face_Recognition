...
if __name__ == '__main__':
    ...
    probe_set, gallery_set = eval_template.load_probe_gallery_set(path_probe, path_gallery, delim=",")
    ...
    mask = eval_template.compute_mask_lfr(probe_set["img_id"], gallery_set["img_id"])
