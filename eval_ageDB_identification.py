...
if __name__ == '__main__':
    ...
    if gallery_set_filename == '':
        gallery_set_filename = "gallery_set_gap_{0}.txt".format(gap)
        
    probe_set_filename = args.probe_set
    if probe_set_filename == '':
        probe_set_filename = "probe_set_gap_{0}.txt".format(gap)
    ...
    mask = compute_mask_agedb(probe_set["img_id"], gallery_set["img_id"])
