...
if __name__ == '__main__':
    ...
    path_probe = metadata_path + "/probe_set_{0}_6.txt".format(ethnicity)
    path_gallery = metadata_path + "/gallery_set1_6.txt"
    ...
    mask = eval_template.compute_mask_vmer(probe_set["img_id"], gallery_set["img_id"])
